...
/* changes */
geninit(L):- L = [(a,1,6),(a,2,7),(a,3,8),(a,4,9),(a,5,10),(a,6,11),
                               (b,1,5),(b,2,6),(b,3,7),(b,4,8),(b,5,9),(b,6,10),(b,7,11) 
                               ,(c,1,4),(c,2,5),(c,3,6),(c,4,7),(c,5,8),(c,6,9),(c,7,10),(c,8,11),
                    (d,1,3),(d,2,4),(d,3,5),(d,4,6),(d,5,7),(d,6,8),(d,7,9),(d,8,10),(d,9,11),
(e,1,2),(e,2,3),(e,3,4),(e,4,5),(e,5,6),(e,6,7),(e,7,8),(e,8,9),(e,9,10),(e,10,11),
 
(f,1,1),
(f,2,2),(f,3,3),(f,4,4),(f,5,5),(f,6,6),(f,7,7),(f,8,8),(f,9,9),(f,10,10),(f,11,11),          

(k,6,1),(k,7,2),(k,8,3),(k,9,4),(k,10,5),(k,11,6),
                               (j,5,1),(j,6,2),(j,7,3),(j,8,4),(j,9,5),(j,10,6),(j,11,7) 
                               ,(i,4,1),(i,5,2),(i,6,3),(i,7,4),(i,8,5),(i,9,6),(i,10,7),(i,11,8),
                    (h,3,1),(h,4,2),(h,5,3),(h,6,4),(h,7,5),(h,8,6),(h,9,7),(h,10,8),(h,11,9),(g,2,1),(g,3,2),(g,4,3),(g,5,4),(g,6,5),(g,7,6),(g,8,7),(g,9,8),(g,10,9),(g,11,10) ].
                    
    
makeattackking(Position,R):- geninit(L),genfroml(L,B,1,X2),genfroml(L,B1,1,X1),getpcX(X2,Position,Ans),Ans=[(k,1)|_],R=[X1|X2].

makeattackqueen(Position,R):- geninit(L),genfroml(L,B,1,X2),genfroml(L,B1,1,X1),getpcX(X2,Position,Ans),Ans=[(q,1)|_],R=[X1|X2].

makeattackrook(Position,R):- geninit(L),genfroml(L,B,1,X2),genfroml(L,B1,1,X1),getpcX(X2,Position,Ans),Ans=[(r,1)|_],R=[X1|X2].

makeattackknight(Position,R):- geninit(L),genfroml(L,B,1,X2),genfroml(L,B1,1,X1),getpcX(X2,Position,Ans),Ans=[(h,1)|_],R=[X1|X2].

makeattackbishop(Position,R):- geninit(L),genfroml(L,B,1,X2),genfroml(L,B1,1,X1),getpcX(X2,Position,Ans),Ans=[(b,1)|_],R=[X1|X2].                    
                    
                    
makerandom(Position,R):- geninit(L),genfroml(L,B,1,X2),genfroml(L,B1,1,X1),R=[X1|X2].
/* till here*/
